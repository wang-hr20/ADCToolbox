function ok = PVRE_confDefault(h)

    PVRE_checkConn(h);
    
    fprintf('PVRE: Writing default configurations to PVRE@%s (ch #%d) ... ', h.addr_disp, h.ch);
    ...
    CH341_I2C(h.addr, [hex2dec('40'),hex2dec('00'),hex2dec('80')], 0);  % VOUT_MAX is 4V
    CH341_I2C(h.addr, [hex2dec('44'),hex2dec('00'),hex2dec('00')], 0);  % VOUT_MIN is 0V
    ...
    CH341_I2C(h.addr, [hex2dec('D0'),hex2dec('42'),hex2dec('00')], 0);  
